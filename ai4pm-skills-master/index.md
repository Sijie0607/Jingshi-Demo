...
欢迎使用 **AI4PM 技能库**。本库专为产品经理和数字化转型顾问设计，提供从客户战略洞察到高保真原型生成的全链路 AI 辅助工具。
...
- **[高级原型生成器 (Prototype Generator)](prototype-generator/SKILL.md)**: 生成包含多 Persona、真实数据建模和多路径演示的 React 原型项目。
...
- **[12306火车票退改签客服 Agent (Ticket QA Agent)](ticket-qa-agent/SKILL.md)**: 基于本体与规则库构建的12306火车票退改签智能客服问答技能。
...
- **方案与 Agent 规则设计**: 组合使用 `AI Opportunity Map` -> `AI Canvas` -> `Agent Ontology Designer` -> `AI Scenario Matrix`。
