...
description: |
  高级原型生成器 —— 根据用户需求直接生成功能完整、设计专业、可直接演示的前端原型。

  Triggers when user mentions:
  - "生成高级原型"
  - "generate advanced prototype"
  - "创建可演示原型"
...
> - **根目录**: 所有生成的项目文件夹必须放在当前工作目录下的一个新子目录中，目录名为 `[公司/业务名]` (例如：`张雪机车海外销售/`)。
> - **项目文件夹名**: 原型项目文件夹名格式为 `prototype-[业务名]` (例如：`prototype-jiche-overseas`)。
